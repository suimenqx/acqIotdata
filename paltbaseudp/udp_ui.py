...
class ToolsUi(QDialog):
    ...
    def __init__(self, num):
        ...
        self.textBrowser_recv.insertPlainText("windows : %s\n" % self.num)
    ...
    def ui_translate(self):
        ...
        self.setWindowTitle(self._translate("TCP-UDP", "IOT Data Server %s" % self.num))
        # self.comboBox_tcp.setItemText(0, self._translate("TCP-UDP", "TCP IOT Server"))
        # self.comboBox_tcp.setItemText(1, self._translate("TCP-UDP", "TCP IOT Client"))
        self.comboBox_tcp.setItemText(0, self._translate("TCP-UDP", "UDP IOT Server"))
        self.comboBox_tcp.setItemText(1, self._translate("TCP-UDP", "UDP IOT Client"))
        # self.comboBox_tcp.setItemText(4, self._translate("TCP-UDP", "WEB IOT Server"))
        self.pushButton_link.setText(self._translate("TCP-UDP", "start"))
        self.pushButton_unlink.setText(self._translate("TCP-UDP", "stop"))
        self.pushButton_get_ip.setText(self._translate("TCP-UDP", "Get IP"))
        self.pushButton_clear.setText(self._translate("TCP-UDP", "clear"))
        self.pushButton_send.setText(self._translate("TCP-UDP", "send"))
        self.pushButton_exit.setText(self._translate("TCP-UDP", "exit"))
        self.pushButton_dir.setText(self._translate("TCP-UDP", "选择路径"))
        self.pushButton_else.setText(self._translate("TCP-UDP", "new window"))
        self.label_ip.setText(self._translate("TCP-UDP", "IP:"))
        self.label_port.setText(self._translate("TCP-UDP", "Port:"))
        self.label_sendto.setText(self._translate("TCP-UDP", "Dst_IP:"))
        self.label_rev.setText(self._translate("TCP-UDP", "Data : "))
        self.label_send.setText(self._translate("TCP-UDP", "command line"))
        self.label_dir.setText(self._translate("TCP-UDP", "请选择index.html所在的文件夹"))
        self.label_written.setText(self._translate("TCP-UDP", "IOT Data Platform"))
    ...
    def combobox_change(self):
        ...
        if self.comboBox_tcp.currentIndex() == 1 or self.comboBox_tcp.currentIndex() == 3:
            ...
            self.textEdit_send.show()
            self.label_port.setText(self._translate("TCP-UDP", "Dst_Port:"))
