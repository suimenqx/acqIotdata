...
from tcp_IOTplat import tcp_ui
import socket
import threading
import sys
import time
import datetime
from tcp_IOTplat import sqltry
from tcp_IOTplat import stopThreading


class TcpLogic(tcp_ui.ToolsUi):
            ...
            for client, address in self.client_socket_list:
                try:
                    ...
                    if recv_msg:
                        ...
                        sqltry.insert_iot_data(up_time, '{}:{}'.format(address[0], address[1]), up_type, up_data,
                                               up_msg)
                        self.signal_write_msg.emit(msg)
                    else:
                        client.close()
